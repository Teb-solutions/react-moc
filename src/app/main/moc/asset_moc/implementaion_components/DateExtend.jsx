...
const DateExtend = (props) => {
    const { dateExtendopen, handlehandledateExtendClose, task, ShowTask, formatDates, AdapterDateFns, reqDate, setReqDate, setDueDateValidation, dueDateValidation, setDueDateCommentValidation, commentss, setCommentss, dueDateCommentValidation, handleSubmits } = props
    const styleExt = {
        position: "absolute",
        top: "50%",
        left: "50%",
