...
const PssrCheckListPart = (props) => {
    ...
    const { PssrCheckListData, documentCountsImp, checklistData, radioState, handleRadioChange, showPssrEdit, remarksState, handleCommentsChange, handleOpenPssR, handleSubmitCheckList, setShowPssrCheckList, setShowPssrEdit } = props
    ...
    return (
        <Box className="p-30 pt-24 pb-24" sx={{ width: "100%" }}>
                    ...
                    <>
                        <Box key={index} mb={4}>
                            ...
                            {matchingChildData.map((child) => {
                                ...
                                if (PssrCheckListData && PssrCheckListData?.pssrData && PssrCheckListData?.pssrData.length !== 0) {
                                    ...
                                    let bombayData = checklistData.filter(e => e.particular === child.value)
                                    documentCount =
                                        documentCountsImp[bombayData[0]?.documentId] ||
                                        0;
                                }
                                ...
                                return (
                                    ...
                                    >
                                            ...
                                            <>
                                                ...
                                                >
                                                    <FormControlLabel
                                                        ...
                                                        control={<Radio />}
                                                        label="Yes"
                                                        disabled={PssrCheckListData?.pssrData?.length > 0 ? !showPssrEdit && (
                                                            matchingPssrData?.checklistReviewStatus &&
                                                            !showPssrEdit) : ""
                                                        }
                                                    />
                                        ...
                                        <StyledBadge badgeContent={documentCount}>
                                            <Button
                                                disabled={(radioState[child.value] ||
                                                    matchingPssrData?.checklistReviewStatus ||
                                                    "") === ""}
                                                className="whitespace-nowrap"
                                                style={{
                                                    border: "1px solid",
                                                    backgroundColor: (radioState[child.value] ||
                                                        matchingPssrData?.checklistReviewStatus ||
                                                        "") === "" ? "rgb(237 233 233)" : "#0000",
                                                    color: "black",
                                                ...
                                                onClick={() => {
                                                    ...
                                                    let bombayData = checklistData.filter(e => e.particular === child.value)
                                                    handleOpenPssR(matchingPssrData?.id ? matchingPssrData?.id : bombayData[0]?.documentId);
                                                }}
                                            >
                                                Document
                                            </Button>
            ...
            >
                ...
                {PssrCheckListData?.pssrData?.length > 0 ? showPssrEdit && (<>
                    <Button
                        className="whitespace-nowrap"
                        variant="contained"
                        color="secondary"
