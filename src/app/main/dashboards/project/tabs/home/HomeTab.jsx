...
function HomeTab() {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={item}>{/* <SummaryWidget /> */}</motion.div>
      <motion.div variants={item}>{/* <OverdueWidget /> */}</motion.div>
      <motion.div variants={item}>{/* <IssuesWidget /> */}</motion.div>
      <motion.div variants={item}>{/* <FeaturesWidget /> */}</motion.div>
      {/* <motion.div
				variants={item}
