          ...
          >
            ...
            >
              ...
              <div className="flex items-center">
                ...
                <button className="focus:outline-none close_button" onClick={closeSidebar}>
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <button
                      ...
                      onClick={handleOpen}
                    >
                      <span className="ml-2 font-semibold"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" fit="" height="24px" width="24px" preserveAspectRatio="xMidYMid meet" style={{display:"inline-block"}} focusable="false">
