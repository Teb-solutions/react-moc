...
const InitiationComplete = ({
  ...
  const handleClassChange = (event) => {
    ...
    if (selectedValue === "Class I") {
      getRecords(1);
    } else if (selectedValue === "Class II") {
      getRecords(2);
    }
  };
  ...
  const handleSubmit = (event) => {
    ...
    const TermDate = new Date(IniComp.docOldValidityDate);
    const ChangeTermDate = new Date(IniComp.docOldValidityDate);
