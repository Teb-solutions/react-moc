...
export default function StickyHeadTable() {
  ...
  const [implementationist, setImplementationist] = useState([]);
  ...
  const filteredDepartmentList = implementationist.filter(
    (row) =>
  ...
  function getRecords() {
    apiAuth.get(`/LookupData/List/implementation`).then((resp) => {
      setIsLoading(false);
      ...
      setImplementationist(transformedData);
    });
  }
  ...
  const handleChangeDense = (event, index) => {
    const updatedDepartmentList = [...implementationist];
    ...
    setImplementationist(updatedDepartmentList);
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      ...
      <MocHeader master={"Master"} type={"Implementation Review"} />
      ...
      <Paper className="box_reset" sx={{ width: "100%", overflow: "hidden" }}>
        ...
        <TablePagination
          ...
          component="div"
          count={implementationist.length}
