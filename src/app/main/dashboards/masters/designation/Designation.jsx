...
export default function StickyHeadTable() {
  ...
  const filteredDepartmentList = designationList.filter(
    (row) =>
  ...
  function getRecords() {
    apiAuth.get(`/LookupData/List/designation`).then((resp) => {
      ...
      setDesignationList(transformedData);
    });
  }
  ...
  const handleChangeDense = (event, index) => {
    const updatedDepartmentList = [...designationList];
    ...
    setDesignationList(updatedDepartmentList);
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      ...
      <MocHeader master={"Master"} type={"Designation"} />
