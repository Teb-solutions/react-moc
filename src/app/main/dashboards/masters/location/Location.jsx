...
export default function StickyHeadTable() {
  ...
  const filteredDepartmentList = locationList.filter(
    (row) =>
  ...
  function getRecords() {
    apiAuth.get(`/LookupData/List/location`).then((resp) => {
      setIsLoading(false);
  ...
  const handleChangeDense = (event, index) => {
    const updatedDepartmentList = [...locationList];
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      <MocHeader master={"Master"} type={"Location"} />
