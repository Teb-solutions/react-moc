...
export default function StickyHeadTable() {
  ...
  const filteredDepartmentList = functionList.filter(
    (row) =>
  ...
  function getRecords() {
    apiAuth.get(`/LookupData/List/function`).then((resp) => {
      setIsLoading(false);
  ...
  const handleChangeDense = (event, index) => {
    const updatedDepartmentList = [...functionList];
    ...
    setfunctionList(updatedDepartmentList);
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      <MocHeader master={"Master"} type={"Function"} />
