...
export default function StickyHeadTable() {
  ...
  function getRecords() {
    apiAuth.get(`/LookupData/List/highriskactivity`).then((resp) => {
      setIsLoading(false);
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      <MocHeader master={"Master"} type={"High Risk Activity"} />
