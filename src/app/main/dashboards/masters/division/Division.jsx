...
export default function StickyHeadTable() {
  ...
  const [divisiontList, setDivisionList] = useState([]);
  ...
  const filteredDepartmentList = divisiontList.filter(
    (row) =>
  ...
  function getRecords() {
    apiAuth.get(`/LookupData/List/division`).then((resp) => {
      ...
      setDivisionList(transformedData);
    });
  }
