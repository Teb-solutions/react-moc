...
const severityRatingArray = [
  {
    type: hazardTypeList.BiologicalRisk,
    array: [
      {
        rating: 40,
        group: "Group 4",
...
const SeverityRatingTable = () => {
  const ratingObj = severityRatingArray.find(
    (item) => item.type === hazardTypeList.BiologicalRisk
  );
          ...
          <>
            ...
            <ul style={{ listStyleType: "circle" }} className="ml-10">
              ...
              <li>
                ...
                consumption (pipes, tanks) fixed and mobile tanks and sanitary
                hot water without return circuit
              </li>
        ...
        preventionMeasures: (
          <>
            ...
            <ul style={{ listStyleType: "circle" }} className="ml-10">
              ...
              <li>
                Use of specific PPE (FPP3-type respirators, gloves and
                protective bodywear).
              </li>
              <li>
