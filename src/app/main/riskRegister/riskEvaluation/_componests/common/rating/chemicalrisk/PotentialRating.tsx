    ...
    <div className="mx-10">
      ...
      >
        <thead className="bg-blue-400 text-white">
          <tr>
            <th className="py-10 px-4 border border-gray-400">Rating</th>
        ...
        <tbody>
          ...
          >
            ...
            <td className="py-1 px-4 border border-gray-400 text-left">
              
                <li>
                  The daily quantity available at the workplace or the
                  concentration of dust in the space in question;
                </li>
                <li>The storage (proximity of incompatible products);</li>
                <li>
                  The physical state of the product at the working temperature
                  (flashpoint of liquids, grain size of suspended dust, gas);
                  The process (dispersive or non-dispersive: open, closed
                  openable, closed for liquids, confined or non-confined for
                  dust);
                </li>
                <li>The sources of inflammation close to the workplace;</li>
                <li>
                  The conditions of use (e.g. friction of polymers against the
                  loading chute produces static electricity);
                </li>
                <li>
                  The presence of an explosive atmosphere: sufficient mixture of
                  air and combustible gas/vapor/fog/dust;
                </li>
                <li>
                  The existing, maintained ventilation or capture systems, the
                  existing fixed storage conditions.
                </li>
