  ...
  const filteredData = useMemo(() => {
    return _.filter(data, (item) => {
      if (selectedCategory !== "all") {
        if (useParamsId === paramValues.category && item.requestTypeName !== selectedCategory) {
          return false;
        }
        if (useParamsId === paramValues.class && item.classCategory !== selectedCategory) {
          return false;
        }
