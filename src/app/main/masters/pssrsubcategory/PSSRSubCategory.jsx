...
export default function StickyHeadTable() {
  ...
  const [pssrsubcategoryList, setPssrsubcategoryList] = useState([]);
  ...
  const filteredDepartmentList = pssrsubcategoryList.filter(
    (row) =>
  ...
  function getRecords() {
    apiAuth.get(`/LookupData/List/pssrsubcategory`).then((resp) => {
      setIsLoading(false);
      ...
      setPssrsubcategoryList(transformedData);
    });
  }
    ...
    <div style={{ backgroundColor: "white" }}>
      ...
      <Paper className="box_reset" sx={{ width: "100%", overflow: "hidden" }}>
        ...
        <TablePagination
          ...
          component="div"
          count={pssrsubcategoryList.length}
