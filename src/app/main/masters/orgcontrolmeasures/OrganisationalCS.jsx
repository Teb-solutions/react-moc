...
export default function StickyHeadTable() {
  ...
  const [lookupAdd, setLookUpAdd] = useState({
    LookupType: "organisationalcontrolmeasure",
    code: "",
    crudMode: "INSERT",
    description: "",
    isActive: true,
  ...
  function getRecords() {
    apiAuth
      .get(`/LookupData/List/organisationalcontrolmeasure`)
      .then((resp) => {
        setIsLoading(false);
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      <MocHeader master={"Master"} type={"Organisational Control Measures"} />
      ...
      <div>
        <div className="flex d-flex flex-col p-30 pt-24 pb-24 justify-between flex-wrap task_form_area sm:flex-row w-full sm:w-auto space-y-16 sm:space-y-0 sm:space-x-16">
          <InputLabel
            ...
            style={{ color: "black" }}
          >
            <b>Organisational Control Measures</b>
          </InputLabel>
