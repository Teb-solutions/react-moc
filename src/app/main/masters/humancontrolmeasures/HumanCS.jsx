...
export default function StickyHeadTable() {
  ...
  const [lookupAdd, setLookUpAdd] = useState({
    LookupType: "humancontrolmeasure",
    code: "",
    crudMode: "INSERT",
    description: "",
    isActive: true,
  ...
  function getRecords() {
    apiAuth.get(`/LookupData/List/humancontrolmeasure`).then((resp) => {
      setIsLoading(false);
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      <MocHeader master={"Master"} type={"Human Control Measures"} />
